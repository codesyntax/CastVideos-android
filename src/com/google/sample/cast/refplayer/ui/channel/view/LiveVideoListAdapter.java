 ...
 */
public class LiveVideoListAdapter extends RecyclerView.Adapter<VideoListItemViewHolder> {
    private final ItemClickListener mClickListener;
    private List<VideoListItemViewModel> videos;

    public LiveVideoListAdapter(ItemClickListener clickListener) {
    ...
    public void onBindViewHolder(final VideoListItemViewHolder viewHolder, final int position) {
        ...
        if (video.getBegin().before(Calendar.getInstance().getTime()) && video.getEnd().after(Calendar.getInstance().getTime())) {
            viewHolder.hideDuration();
